...
import com.ramazantiftik.bingo.databinding.ActivityBingoBinding;
...
public class BingoActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId()==R.id.backToHome){
            Intent intent=new Intent(BingoActivity.this,InterfaceActivity.class);
    ...
    public void tick(View view){
        ...
        tickCount++;
        if(tickCount==15){
            MediaPlayer mediaPlayer=MediaPlayer.create(BingoActivity.this,R.raw.sound);
            mediaPlayer.start();
